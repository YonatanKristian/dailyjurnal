    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Masukkan data User</h1>
...
if (isset($_POST['simpan'])) {
    ...
    $password = isset($_POST['password']) ? md5(string: $_POST['password']) : NULL;
    $gambar = '';
    ...
    if (isset($_POST['id'])) {
        ...
        $stmt = $conn->prepare("UPDATE user2
                                SET 
                                gambar = ?,
                                password =?,
                                username = ?
        ...
        $stmt->bind_param("sssi",  $gambar, $password, $username, $id);
        $simpan = $stmt->execute();
    } else {
		    //jika tidak ada id, lakukan insert data baru
        $stmt = $conn->prepare("INSERT INTO user2 (password,gambar,username)
                                VALUES (?,?,?)");
